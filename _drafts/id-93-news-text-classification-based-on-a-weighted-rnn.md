...
2. Use GRU blocks as the RNN units while developing the model. Vanilla RNN/LSTM blocks won't be accepted.
3. Show comparison with C-RNN model and baseline GRU-based RNN model