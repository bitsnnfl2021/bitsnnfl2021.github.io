...
2. Tokenize using text__to__word_sequence, and perform word embedding of the files using the 'Word2vec' technique as available in the Gensim library, as given in the paper. Make necessary and logical assumptions of parameters wherever necessary.
