...
4. Report graph of loss function & accuracy vs. epochs in training data, and confusion matrix, precision, recall, F1 score, and accuracy for all three cases for the test set (in the notebook).