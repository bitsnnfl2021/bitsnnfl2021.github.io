...
4. Report the graph of the loss function & accuracy vs. epochs for training data, and confusion matrix, precision, recall, F1 score and accuracy of the model for the test case.